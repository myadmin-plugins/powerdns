...
function doAuthenticate() {
	...
	if(isset($_SESSION["userlogin"]) && isset($_SESSION["userpwd"]))
	{
		...
		$result = $db_mdb2->query("SELECT id, fullname FROM users WHERE username=". $db_mdb2->quote($_SESSION["userlogin"], 'text')  ." AND password=". $db_mdb2->quote(md5($_SESSION["userpwd"]), 'text')  ." AND active=1");
		if($result->numRows() == 1)
		{
