...
$valid_tlds = [
	"aaa", "aarp", "abb", "abbott", "abogado", "ac", "academy",
 ...
 * @param int|string $id        Page specific ID (Zone ID, Template ID, etc)
 * @return null
 */
...
function show_letters($letterstart, $userid) {
    ...
    $char_range = array_merge(range('a', 'z'), ['_']);
